...
**v4 changelog (2026-09-25, D1):** the four open questions carry their R1 answers in place; nothing else changed.
...
## OPEN QUESTIONS — RESOLVED (PUBLISHER-REVIEW-R1) · RECORDED
...
3. ~~The swing bake-off first~~ **RECORDED (R1 go-ahead): logged as the loop's testing job #1** — ran on synthetic data only (Sprints 1–2, feed synthetic-v1); as of 2026-09-25 it has never run on real prices. Execution pending (decision D7).
...
*Chapter 1 v4 · 28 cards · all DRAFT (publisher-reviewed; C1–C4 and C-R5-1 applied). Compiled against: nothing (this is the root). Cited by: everything. — THE SCINTILLA RULEMAKER*
