...
- provider_indicators_current(ticker,provider,timeframe,indicator,period_length,value,source_date,session_state,fetched_at,universe_hash) — current raw FMP daily indicators. Provider must be FMP. Accepted source-artifact identities are 7ad595cc4db5e1fd0bb63bb3780ac1450a938e6fa068df944aeec71445556063 (preserved reference), ab8f7965258d939f0a97fbfeac9a271547c258df7a2616aff6ccff746bb5d9d3 (the 364-name universe served until 2026-09-24; rows stamped with it are still valid reference) and 0c2abd57a836845ee120eba1e465cdb61db6a2cca5b3da1fcecbdc591936bb20 (current accepted 424-name universe, M57 admission). A row carrying any other identity is not accepted. A current-day daily value can be FORMING; say so. Intraday FMP indicator authority is not verified and must be reported unavailable.
