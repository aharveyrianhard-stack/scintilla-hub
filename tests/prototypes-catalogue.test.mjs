...
test("the reviewed page and preview bytes; the lab's home is present", () => {
  assert.equal(sha("index.html"), "03d21bf381e22df6346aff7d1d422bad151a0056f47ca610f5bde12f9639fd57");   // rebuilt 23 Sep (M18): one scrolling page on the 3D-workshop model - picture band, chips, dates - in greys, no hidden tabs
