...
test("the reviewed page and preview bytes; the lab's home is present", () => {
  assert.equal(sha("index.html"), "66480f24200305483a0b142316dfbb73f4d9ad4a8337e70199dabddb56d96e91");   // rebuilt 23 Sep (M18): one scrolling page on the 3D-workshop model - picture band, chips, dates - in greys, no hidden tabs
